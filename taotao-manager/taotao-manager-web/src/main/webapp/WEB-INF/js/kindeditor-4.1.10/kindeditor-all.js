...
KindEditor.plugin('filemanager', function(K) {
	...
	self.plugin.filemanagerDialog = function(options) {
		...
		function reloadPage(path, order, func) {
			var param = 'path=' + path + '&rest=' + order + '&dir=' + dirName;
 ...
 *   since many of the settings need to be passed to Flash in rest to take
 *   effect.
 * *********************** */
...
/* *******************************
	...
	This ensures that events are executed in a determinate rest and that
...
// we must queue them in rest to garentee that they are executed in rest.
